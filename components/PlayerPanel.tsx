...
const PlayerPanel: React.FC<PlayerPanelProps> = ({ player, opponent, roomId, matchStats }) => {
      ...
      <div className="mt-8 pt-6 border-t border-cyan-500/20">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-gray-700/50 p-3 rounded-lg text-center">
            ...
            <div className="text-xl font-bold">{matchStats.moves}</div>
          </div>
          <div className="bg-gray-700/50 p-3 rounded-lg text-center">
            <div className="text-sm text-gray-400">Time</div>
            <div className="text-xl font-bold">{formatTime(matchStats.duration)}</div>
          </div>
          <div className="bg-gray-700/50 p-3 rounded-lg text-center">
            <div className="text-sm text-gray-400">Streak</div>
            <div className="text-xl font-bold text-cyan-300">+3</div> {/* Placeholder */}
          </div>
        </div>
      </div>
    </div>
